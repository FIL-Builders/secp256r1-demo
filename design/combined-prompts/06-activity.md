# Activity Combined Execution Prompt

<!-- markdownlint-disable MD013 MD012 MD024 MD025 -->

Use this file as a standalone prompt for generating the Activity page. It already includes the shared product context, reviewed consumer UI direction, page requirements, and page-specific generation instructions.
...
Purpose: timeline for storage, payments, passkey session events, and verification checks.
...
Use friendly labels by default. Chain-backed details should open one click away.
