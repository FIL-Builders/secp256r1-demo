# Network And Unsupported States Combined Execution Prompt

<!-- markdownlint-disable MD013 MD012 MD024 MD025 -->

Use this file as a standalone prompt for generating the Network And Unsupported States page. It already includes the shared product context, reviewed consumer UI direction, page requirements, and page-specific generation instructions.
...
Purpose: design the behavior around Mainnet/Calibration switching and unsupported states.
